...
<footer id="colophon" class="footer mt-auto py-3 ">
	<div class="container" id="site-publisher" itemprop="publisher" itemscope itemtype="https://schema.org/Person">
		<div class="d-flex flex-wrap justify-content-between align-items-center pt-2 mt-4 border-top">
			...
			<img class="d-none" itemprop="image" src="https://imagedelivery.net/0XfRl_9i2twIzyWa9HYA4g/8d2d2eb3-54e6-40b6-7a67-8941d09c0700/400x" />
			<ul class="nav col-md-4 justify-content-end">
				<?php get_template_part('template-parts/social', 'icons'); ?>
			</ul>
		</div>
		<div class="d-flex flex-wrap justify-content-center">
			<img id="footer-image" class="d-block my-0 img-fluid" src="<?php echo $logo_img_url; ?>" alt="Killentime logo" />
		</div>
	</div>
</footer>
