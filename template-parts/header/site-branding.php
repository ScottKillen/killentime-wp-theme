...
<div id="head" class="text-center py-3 site-branding">
	<div class="d-flex justify-content-center align-items-center">
		<div class="u-photo photo logo" itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
			<img id="site-image" itemprop="url" class="rounded-circle d-block overflow-hidden border bg-body-tertiary border-secondary mx-auto my-0 shadow-lg img-fluid me-2" src="<?php echo $logo_img_url; ?>" alt="Killentime logo" />
