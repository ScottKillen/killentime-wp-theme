...
<div id="page" class="site container">
	...
	<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
		...
		<symbol id="sk-logo" viewBox="0 0 16 16">
			<circle id="Color" cx="8" cy="8" r="7.685" style="fill:rgb(255,196,69);"/>
	...
	<header id="header">
		<div id="head" class="text-center bg-light-subtle py-5">
			<h1 id="logo" class="text-center">
				<svg class="me-2 text-dark" height="4em" width="4em"><use href="#sk-logo" fill="currentColor"></use></svg><br />
				<span class="title">Scott Killen</span>
				<span class="tagline">Stuff he says...</span>
			</h1><!-- #logo -->
		</div><!-- #head -->
	</header> <!-- #header -->
