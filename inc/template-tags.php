...
function kt_the_post_date($before = '', $after = '', $link = true)
{
	...
	printf(
		'<address class="byline d-none"><span class="author p-author vcard hcard h-card" itemprop="author " itemscope itemtype="https://schema.org/Person">%1$s <a class="url uid u-url u-uid fn p-name" href="%2$s" rel="author" itemprop="url"><span itemprop="name">%3$s</span></a></span></address>',
...
function the_syndication_links()
{
	...
	$syn_links = str_replace(
		...
		'<svg class="bi"><title>Medium</title><use href="#fa-medium" /></svg>',
		$syn_links
	);
